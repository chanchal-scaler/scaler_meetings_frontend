    ...
    <>
      ...
      >
        ...
        <div className="m-topic-card__strip-container">
          <div className={classNames('m-topic-card__side-strip',
...
export default SkippedInstructorAlumniCard;
