...
const EndedProblemCard = ({ content }) => {
  ...
  const dynamicClass = content.type === PLAYLIST_CONTENT_TYPES.problem
    ? 'm-quiz-card__done-bg-img'
    : 'm-quiz-card__done-bg-img-poll';
    ...
    <>
      ...
      >
        ...
        <div className="m-topic-card__strip-container">
          <div
            className="m-topic-card__side-strip m-topic-card__side-strip--done"
          />
        </div>
      </div>
...
export default EndedProblemCard;
